...
public class MarqueeTextView extends TextView {
    ...
    public void resumeScroll() {
        ...
        Log.d("MTV", "scrollingLen: " + scrollingLen);
        final int distance = scrollingLen -  mXPaused;
        Log.d("MTV", "mXPaused: " + mXPaused);
        Log.d("MTV", "distance: " + distance);
        final int duration = (Double.valueOf(mRollingInterval * distance * 1.00000
                / scrollingLen)).intValue();
        Log.d("MTV", "duration: " + duration);
        if (mFirst) {
            Log.d("MTV", "if mFirst: " + mFirst);
